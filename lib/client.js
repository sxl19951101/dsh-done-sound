      ...
      const TurnChimeCard = (props) => {
        ...
        const sceneRow = (scene) => {
          ...
          return react.createElement(
            'div',
            { className: 'dtc-row' },
            react.createElement('span', { className: 'dtc-muted' }, L('scene' + scene[0].toUpperCase() + scene.slice(1))),
            react.createElement('span', { className: 'dtc-muted dtc-logpath' }, s.fileName || L('defaultSound')),
            react.createElement(
              'label',
        ...
        return react.createElement(
          ...
          react.createElement(
            ...
            react.createElement('span', { className: 'dtc-muted' }, L('retrySoundHint')),
          ),
          react.createElement(
            'div',
            { className: 'dtc-row' },
